...
import com.snrt.knowledgebase.infrastructure.retrieval.QueryRewriterService;
...
public class RAGCacheManager {
    ...
    public Optional<QueryRewriterService.RewrittenQuery> getCachedRewrittenQuery(String query) {
        long startTime = System.currentTimeMillis();
        String semanticKey = generateSemanticKey(query);
        String cacheKey = REDIS_REWRITE_PREFIX + semanticKey;
        ...
        try {
            ...
            if (json != null) {
                long deserializeStart = System.currentTimeMillis();
                QueryRewriterService.RewrittenQuery result =
                    objectMapper.readValue(json, QueryRewriterService.RewrittenQuery.class);
                long deserializeDuration = System.currentTimeMillis() - deserializeStart;
                long totalDuration = System.currentTimeMillis() - startTime;
